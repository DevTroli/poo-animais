...
public class Pinguim {
  ...
  public Pinguim(String bico, String asaNadadeira, boolean impermeavel, String caudaCurta, String patasPequenas) {
    this.bico = bico;
  ...
  public void socializar() {
    System.out.println("O pinguim se questiona, será que um dia terei outros amigos ou serei para sempre solo no universo? Enquanto caminha em direção a sua montanha infinita de amigos pinguins dançantes");
  }
  ...
  public void infos() {
    System.out.println(
        "🐧 Pinguim {\n"
        + "Bico: " + bico + "\n"
        + "Asa/Nadadeira: " + asaNadadeira + "\n"
        + "Impermeável: " + impermeavel + "\n"
        + "Cauda Curta: " + caudaCurta + "\n"
        + "Patas Pequenas: " + patasPequenas + "\n"
        + "}"
    );
  }
}
